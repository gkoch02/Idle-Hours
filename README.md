...
| `grimoire`    | <img src="assets/previews/grimoire.png" width="240" alt="grimoire theme preview">       | black   | white     | red     | EB Garamond + TFoustScript           | Alchemical Faustian spellbook — Renaissance EB Garamond body in white on a leather-bound black ground, matched time phrase scrawled in red TFoustScript's hollow-outline shaggy silhouette like a magic-circle inscription, single thin red outer rule with a five-pointed pentagram at each corner |
