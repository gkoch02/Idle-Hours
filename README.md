...
| `plaque`      | <img src="idle_hours/assets/previews/plaque.png" width="240" alt="plaque theme preview">           | green       | yellow | red   | Cinzel Decorative    | Patinated bronze plaque (custom layout, relief-lit lettering) |
...
- Theme thumbnail grid: side-by-side previews of all fifty-nine registered themes, rendered against the current quote so you can compare typography + palette before committing. Click a tile to apply it.
