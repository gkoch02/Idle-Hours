...
| `grimoire`    | <img src="idle_hours/assets/previews/grimoire.png" width="240" alt="grimoire theme preview">       | black       | white | red    | IM Fell English + Eagle Lake   | Faustian spellbook       |
...
- Theme thumbnail grid: side-by-side previews of all sixty-one registered themes, rendered against the current quote so you can compare typography + palette before committing. Click a tile to apply it.
