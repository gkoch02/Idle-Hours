...
|---|---|---|---|
| Tangerine / warm orange | red + yellow at 5/8 : 3/8 | `dark=red, light=yellow, light_density=0.375` | `deco` (body matched phrase + border post-pass); `comic` (extra warm-toned 5th band painted manually pixel-by-pixel above the cool chevron — same Bayer threshold as deco) |
